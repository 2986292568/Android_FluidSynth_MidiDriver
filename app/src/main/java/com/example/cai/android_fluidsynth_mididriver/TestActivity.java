...
/**
 * 测试加载sf2音色库或OpenSLES播放midi
 * @author Cai
 */
public class TestActivity extends Activity {

    private ArrayAdapter<String> midiInputEventAdapter;
    private ArrayAdapter<String> midiOutputEventAdapter;
    private ToggleButton thruToggleButton;
    private Spinner cableIdSpinner;
    private Spinner deviceSpinner;

    private ArrayAdapter<UsbDevice> connectedDevicesAdapter;
            ...
            public void onMidiOutputDeviceAttached(@NonNull final MidiOutputDevice midiOutputDevice) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(TestActivity.this, "USB MIDI Device " + midiOutputDevice.getUsbDevice().getDeviceName() + " has been attached.", Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            public void onMidiOutputDeviceDetached(@NonNull final MidiOutputDevice midiOutputDevice) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(TestActivity.this, "USB MIDI Device " + midiOutputDevice.getUsbDevice().getDeviceName() + " has been detached.", Toast.LENGTH_LONG).show();
                    }
                });
            }
...
//				}
				...
				int note = 30 + Integer.parseInt((String) v.getTag());
...
//					midiOutputEventHandler.sendMessage(Message.obtain(midiOutputEventHandler, 0, "NoteOn to: " + midiOutputDevice.getUsbDevice().getDeviceName() + ", cableId: " + cableIdSpinner.getSelectedItemPosition() + ", note: " + note + ", velocity: 127"));
                    sendMidi(NOTE_ON|9,note,127);
                    break;
				case MotionEvent.ACTION_UP:
                    sendMidi(NOTE_OFF|9,note,127);
